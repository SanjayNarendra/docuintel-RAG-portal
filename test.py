#--------------------Document Analysis Testing Code --------------------#

# import os
# from pathlib import Path
# from src.data_ingestion.data_ingestion import DocumentHandler       # PDFHandler class
# from src.document_analyzer.data_analyzer import DocumentAnalyzer    #  DocumentAnalyzer class

# # Path to the PDF you want to test 
# PDF_PATH = r"D:\\LLMOps\\docuintel-RAG-portal\\data\\document_analysis\\sample.pdf"
...
#--------------------Document Comparison Testing Code --------------------#
# Testing code for document comparison using LLMs

# import io
# from pathlib import Path
# from src.document_compare.data_ingestion_test import DocumentIngestion
# from src.document_compare.document_comparator import DocumentComparatorLLM

# # ---- Setup: Simulating streamlit file upload ---- #
# def load_fake_uploaded_file(file_path: Path):
#     return io.BytesIO(file_path.read_bytes())  # simulate .getbuffer()

# # ---- Step 1: Save and combine PDFs ---- #
# def test_compare_documents():
#     ref_path = Path("D:\\LLMOps\\docuintel-RAG-portal\\data\\document_compare\\AI_and_Environment_v1.pdf")
#     act_path = Path("D:\\LLMOps\\docuintel-RAG-portal\\data\\document_compare\\AI_and_Environment_v2.pdf")

#     # Wrap them similar to Streamlit UploadedFile-style
#     class FakeUpload:
...
#--------------------Single Document Chat Testing Code --------------------#
#Testing code for document chat functionality

# import sys
# from pathlib import Path
# from langchain_community.vectorstores import FAISS
# from src.single_document_chat.data_ingestion_test import SingleDocIngestor
...
# def has_faiss_index(dir_path: Path, index_name: str = "index") -> bool:
#     return (dir_path / f"{index_name}.faiss").exists() and (
#         (dir_path / f"{index_name}.pkl").exists() or (dir_path / f"{index_name}.json").exists()
#     )
...
#         if has_faiss_index(FAISS_INDEX_PATH, INDEX_NAME):
...
#                 uploaded_files = [f]
#                 ingestor = SingleDocIngestor(data_dir="data/single_document_chat", faiss_dir=str(FAISS_INDEX_PATH))
...
#     pdf_path = "D:\\LLMOps\\docuintel-RAG-portal\\data\\single_document_chat\\NIPS-2017-attention-is-all-you-need-Paper.pdf"
...
import sys
from pathlib import Path
from src.multi_document_chat.data_ingestion_test import MultiDocIngestor
